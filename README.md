...
Run a discovery session without a running `discovery-service`. Results are stored in-memory and printed to stdout. Useful for one-off runs, CI pipelines, or testing a new network.
